...
![계산기 들여쓰기](../image/week4/image-2.png)
...
![else-if의 위력](../image/week4/image-3.png)

else 있고 block 내부의 if문을 합쳐주는 기능입니다.

![else-if 그림](../image/week4/image-4.png)
...
- 헷갈리면 그림을 그려보자!
  ![조건문 구성요소](../image/week4/image-5.png)
...
![논리연산자 종류](../image/week4/image-6.png)
![not 논리 연산자](../image/week4/image-7.png)
...
![드모르간 법칙](../image/week4/image-10.png)
...
![조건 연산자](../image/week4/image-12.png)
